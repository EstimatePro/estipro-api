...
public static class UserMapper
{
    ...
    public static UserRegistrationDataDto UserToUserRegistrationDataDto(User user, string password)
    {
        return new UserRegistrationDataDto(user.Id, user.Email, user.NickName, password);
    }
}